...
public class KafkaAPI {
     ...
     * kafka 的生产者
     */
    public static void producer() throws IOException, ExecutionException, InterruptedException {

        Properties props = new Properties();
        // kafka集群服务器
        props.put("bootstrap.servers", "10.2.111.54:9092");
        // 设置 ack
        props.put("acks", "1");
        // 设置重试次数,默认为 0
        props.put("retries", 3);
        ...
        // 使用自定义的分区器, 使用默认的则不加
        // props.put("partitioner.class", "com.star.kafka.KafkaPartition");
        //Kafka
        KafkaProducer producer = new KafkaProducer(props);
        producer.send(new ProducerRecord("test4", "31"));
